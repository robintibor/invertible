...
def create_glow_model(
    ...
    for i in range(L):
        ...
        dists_per_scale.append(Unlabeled(
            NClassIndependentDist(1, C * H * W, optimize_mean=False, optimize_std=False)))
